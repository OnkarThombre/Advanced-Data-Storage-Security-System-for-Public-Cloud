...
<body>
	...
	<!-- container -->
	<section class="container" style="width: 1270px;">
		<div class="heading">
			<!-- Heading -->
			<h2>User History</h2>
		</div>
...
<% 
	String query="select * from tbluser where U_Status='Pending'";
...
%>
 <TR>
              ...
              <TD> <a href="U_History_Request?uemail=<%=resultset.getString(3)%>"><input type="submit" name="sendkey" value="Accept" class="btn btn-primary"></a></TD>
              <TD> <a href="U_History_Reject?uemail=<%=resultset.getString(3)%>"><input type="button" name="sendkey" value="Reject" class="btn btn-primary"></a></TD>
           </TR>
<% 
   } 
