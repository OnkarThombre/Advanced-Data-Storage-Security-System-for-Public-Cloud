	...
	<div class="navbar navbar-inverse" style="background-color: black;">
		<div class="container">
			...
			<div class="navbar-collapse collapse">
                    ...
                    <li >
                      <a href="LoginPage"><label style="color: white;"><%=session.getAttribute("U_Name") %></label><b class="caret"></b></a> 
		...
		<div class="container">
			<div class="banner-content">
				<div id="da-slider" class="da-slider">
					...
					<div class="da-slide">
						<h2>Data Storage Security System Based Access Control for Cloud Data</h2>
